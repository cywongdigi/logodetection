...
class LogoDetectionGUI:
    ...
    def load_model(self):
        model = LogoClassifierEnsemble(2074, 256)
        state_dict = torch.load("logodetection.pth")
    ...
    def upload_image(self):
        ...
        if file_path:
            ...
            if image.width > 800 or image.height > 600:
                ...
                image = ImageOps.pad(image, (800, 600), method=Image.LANCZOS, color=(255, 255, 255))
    ...
    def draw_roi_on_image(self, file_path, image, original_width, original_height):
        ...
        for logo in logos:
            ...
            if len(vertices) == 4:
                ...
                # Adjust the ROI box to exclude the yellow border
